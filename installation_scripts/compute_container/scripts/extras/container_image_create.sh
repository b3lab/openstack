...
##############################################################################################
#  lxd için kullanılacak imaja hypervisor_type=lxd verdiğimiz gibi diğer imajlara da         #
#  hypervisor_type=kvm vermek gerekir. Yoksa nova diğer imajları container nodu üzerinde boot#
#  etmeye çalışabilir.									     #
##############################################################################################
